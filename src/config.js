...
export const API_PREFIX = import.meta.env.API_ENDPOINT_PREFIX;
export const API_ENDPOINT_PREFIX = import.meta.env.API_ENDPOINT_PREFIX;
export const API_ENDPOINT_SUFFIX = import.meta.env.API_ENDPOINT_SUFFIX;
